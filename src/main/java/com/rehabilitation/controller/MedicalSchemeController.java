...
public class MedicalSchemeController {
    ...
    private final MedicalSchemeService medicalSchemeService;
    ...
    @PutMapping("/{id}/end")
    public Result<Boolean> endMedicalScheme(@PathVariable Long id) {
        boolean result = medicalSchemeService.endMedicalScheme(id);
        return Result.success(result);
    }
