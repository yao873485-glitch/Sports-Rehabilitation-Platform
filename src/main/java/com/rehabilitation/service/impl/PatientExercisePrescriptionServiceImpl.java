...
public class PatientExercisePrescriptionServiceImpl implements PatientExercisePrescriptionService {
    ...
    private final PatientExercisePrescriptionMapper patientExercisePrescriptionMapper;
    private final PatientPrescribedExerciseMapper patientPrescribedExerciseMapper;
    ...
    public Long savePrescription(PrescriptionSaveDTO prescriptionSaveDTO) {
        ...
        if (prescriptionSaveDTO.getSchemeId() != null && !prescriptionSaveDTO.getSchemeId().isEmpty()) {
            try {
                prescription.setMedicalSchemeId(Long.parseLong(prescriptionSaveDTO.getSchemeId()));
        ...
        prescription.setExecutionInstitution(patientInfo.getEnrollmentInstitution());
        prescription.setPrescriptionStatus(1); // 1-未开始
        ...
        for (PrescriptionSaveDTO.ExerciseItemDTO exerciseItem : prescriptionSaveDTO.getExerciseList()) {
            ...
            exercise.setExecutionInstitution(patientInfo.getEnrollmentInstitution());
            exercise.setPrescriptionStatus(1); // 1-未开始
