...
public class ChatServiceImpl 
    ...
    public ChatMessageVO sendMessage(Long receiverId, String content, String messageType) {
        ...
        businessEventPublisher.publishChatEvent("CHAT_SEND", conversationId, senderId, receiverId);
    ...
    public void markAsRead(String conversationId, Long receiverId) {
        ...
        businessEventPublisher.publishChatEvent("CHAT_READ", conversationId, null, receiverId);
    }
