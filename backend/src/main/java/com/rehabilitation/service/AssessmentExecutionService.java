...
public interface AssessmentExecutionService {
     ...
     * 获取评估执行信息（用于执行弹窗）
     *
     * @param assessmentPlanId 评定方案ID
     * @return 评估执行信息
     */
    AssessmentExecutionInfoVO getAssessmentExecutionInfo(Integer assessmentPlanId);
     ...
     */
    void submitAssessmentExecution(AssessmentExecutionSubmitDTO submitDTO);
}