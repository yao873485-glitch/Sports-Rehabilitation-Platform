  ...
  <div class="image-detail-container">
    <el-card>
      <div slot="header" class="detail-header">
        ...
        <span class="detail-title">{{ detailData.contentTitle || '加载中...' }}</span>
      ...
      <div v-loading="loading" class="detail-content">
        <el-form label-width="120px" class="detail-form">
          <el-form-item label="视频ID">
            <div class="form-value">{{ detailData.contentId || '--' }}</div>
          </el-form-item>

          <el-form-item label="视频标题">
            <div class="form-value">{{ detailData.contentTitle || '--' }}</div>
          </el-form-item>
          ...
          <el-form-item label="文章内容">
            <div class="form-value">{{ detailData.articleDescription || '--' }}</div>
          </el-form-item>
...
<script>
import { getContentDetail } from '@/api/education'
