  ...
  <div class="assessment-list-container">
    ...
    <el-card class="list-card" shadow="never">
      <div class="table-container">
        ...
        >
          <el-table-column prop="序号" label="序号" width="100" align="center" fixed="left" />
          <el-table-column prop="量表名称" label="量表名称" width="350" align="center" />
          <el-table-column prop="创建时间" label="创建时间" width="220" align="center" />
          <el-table-column prop="执行时间" label="执行时间" width="220" align="center" />
          <el-table-column prop="执行人员" label="执行人员" width="180" align="center" />
          <el-table-column prop="执行设备" label="执行设备" width="200" align="center" />
        ...
        <div class="pagination-info">
          <span>当前显示1-{{ assessmentList.length }}条，总共 {{ total }} 条数据</span>
          <el-pagination
...
export default {
  ...
  created() {
    ...
    if (patientId) {
      ...
      this.loadAssessmentList(patientId, schemeId)
    }
  },
  methods: {
    // 加载患者信息
    ...
    // 加载评定执行清单
    loadAssessmentList(patientId, schemeId) {
      // TODO: 调用API获取评定执行清单
      console.log('加载评定执行清单，patientId:', patientId, 'schemeId:', schemeId)
      // 临时空数据
      this.assessmentList = []
      this.total = 0
    },
